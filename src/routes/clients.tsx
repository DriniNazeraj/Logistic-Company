...
export const Route = createFileRoute("/clients")({
  head: () => ({
    meta: [
      { title: "Klientet — transport.square.al" },
    ...
    <FormShell onSubmit={submit}>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Field label={t("common.phone")}>
          <Input type="tel" inputMode="numeric" value={phone} onKeyDown={(e) => { if (/[a-zA-Z]/.test(e.key) && e.key.length === 1) e.preventDefault(); }} onChange={(e) => setPhone(e.target.value.replace(/[a-zA-Z]/g, ""))} placeholder="+355 69..." />
        </Field>
