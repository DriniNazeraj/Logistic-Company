...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Trans Square — Cargo Shipping USA to Albania" },
    ...
    <div className="min-h-screen bg-white text-neutral-900" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <nav className="sticky top-0 z-50 border-b border-neutral-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="text-xl font-bold tracking-tight">Trans Square</div>
        ...
        <div className="mx-auto max-w-6xl px-6 py-20 md:py-32">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 max-w-lg text-lg text-neutral-600">
              Trans Square offers reliable cargo shipping services from the United States to Albania. Fast, secure, and cost-effective deliveries tailored to your needs.
            </p>
      ...
      <section id="why-us" className="bg-neutral-900 py-16 text-white md:py-24">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold tracking-tight md:text-4xl">
            Why Clients Trust<br />Trans Square
          </h2>
        ...
        <div className="grid gap-12 md:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-neutral-600">
              Find answers to common questions about our shipping services and how Trans Square can help.
            </p>
          </div>
      ...
      <section id="contact" className="bg-neutral-900 py-12 text-white">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-6 md:flex-row">
          <div>
            <h2 className="text-2xl font-bold md:text-3xl">Ready to ship with Trans Square?</h2>
      ...
      <footer className="border-t border-neutral-200 bg-white py-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-6 md:flex-row">
          <div>
            <div className="text-lg font-bold tracking-tight">Trans Square</div>
        ...
        <div className="mx-auto mt-6 max-w-6xl px-6 text-center text-xs text-neutral-400">
          &copy; {new Date().getFullYear()} Trans Square. All rights reserved.
        </div>
      </footer>
    </div>
  );
